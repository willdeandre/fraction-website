...
const brands = [
    { name: "NBPA", src: "/brands/nbpa.png" },
    { name: "NBA", src: "/brands/nba.png" },
    { name: "FIBA", src: "/brands/fiba.png" },
    { name: "Alabama", src: "/brands/alabama.png" },
    { name: "NBA", src: "/brands/nba.png" },
    { name: "Ohio State", src: "/brands/osu.png" },
    ...
    { name: "Vanderbilt", src: "/brands/vanderbilt.png" },
    { name: "Lehigh", src: "/brands/lehigh.png" },
    ...
    // not showing { name: "Hampton", src: "/brands/hampton.png" },
    { name: "Minnesota", src: "/brands/minnesota.png" },
    // not showing { name: "Pancheros", src: "/brands/pancheros.png" },
    { name: "Texas", src: "/brands/texas.png" },
    // not showing { name: "Illinois State", src: "/brands/illinois-state.png" },
